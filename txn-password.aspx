...
<body>
    <form method="post" action="./txn-password.aspx" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTE4NDg4MTM1MjVkZAhg3odgMRn1XDQoHpRc80sf+/mBKiwy6PZ3IA9q+Od+" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="93C86DA6" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAXOjSD4nOXWpDyqCMzH++MLepRWkK7F0cJ07W8SmllpC0J0yJWcqvi8e69cDXV7JisbWspWvJra0RVqSz40I/V29q+USZ1fG/mur8aiyru+SwobYD/z4PulOblXm6kQ6gD8tBi3TqKEEcl18p3H0yng" />
</div>
        <div class="container-box">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <h5 class="fw-bold m-0">Transaction Password</h5>
                <div></div>
            </div>
