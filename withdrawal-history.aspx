...
<body>
    <form method="post" action="./withdrawal-summary.aspx" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTE2ODY4NDMzNTcPZBYCAgMPZBYCAgEPFgIeC18hSXRlbUNvdW50ZmRkAgy24rUPcxwM+00vWo6DtMW1qzXKVHfiSfrM/bRdEgg=" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="6167B30D" />
</div>
        ...
        <div class="container-box rounded">
            ...
            <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3">
                <a href="withdrawal-now.aspx" class="text-decoration-none text-dark">
                    <i class='bx bx-arrow-back fs-4'></i>
                </a>
                <h5 class="m-0 fw-bold text-center flex-grow-1">Withdrawal Summary</h5>
