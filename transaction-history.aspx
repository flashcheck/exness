...
<body>
    <form method="post" action="./transaction-history.aspx" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNjM3NjkxMDI1D2QWAgIDD2QWAgIBDxYCHgtfIUl0ZW1Db3VudGZkZKgzqrn7u5NUrR/icgf8xkBgAj2XlBWY9rXQVmZWGdNZ" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="258922A5" />
</div>
        <div class="container-box">

            <!-- Header -->
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a href="dashboard.aspx" class="text-dark text-decoration-none">
